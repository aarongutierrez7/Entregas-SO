...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string mensaje = "1/" + temp.Text + "/" unidad.Text;
                ...
                MessageBox.Show("El resultado de la conversión es: " + mensaje);
            }
        ...
        private void Temperatura_CheckedChanged_1(object sender, EventArgs e)
        {
